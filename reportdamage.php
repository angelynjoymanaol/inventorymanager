...
V I E W &emsp; D E P L O Y E D&emsp; E Q U I P M E N T</p>
...
$TotalRec = mysql_result(mysql_query("SELECT COUNT(*) FROM damage WHERE date >= '$_POST[begin]'  AND date <= '$_POST[last]'"), 0);
...
{
  echo '<a href='."./reportdamage.php?id=" . ($start - $perpage) . '>'."Previous".'</a>';
}?>
...
{
  echo '<a href='."./reportdamage.php?id=" . ($start + $perpage) . '>'."Next".'</a>';
}
